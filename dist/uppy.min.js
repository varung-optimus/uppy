...
"use strict";var Core=require("./core/index.js"),Plugin=require("./plugins/Plugin"),Dashboard=require("./plugins/Dashboard/index.js"),Dummy=require("./plugins/Dummy"),DragDrop=require("./plugins/DragDrop/index.js"),FileInput=require("./plugins/FileInput.js"),GoogleDrive=require("./plugins/GoogleDrive/index.js"),Dropbox=require("./plugins/Dropbox/index.js"),Webcam=require("./plugins/Webcam/index.js"),Ftp=require("./plugins/Ftp/index.js"),ProgressBar=require("./plugins/ProgressBar.js"),Informer=require("./plugins/Informer.js"),MetaData=require("./plugins/MetaData.js"),Tus10=require("./plugins/Tus10"),Multipart=require("./plugins/Multipart"),Transloadit=require("./plugins/Transloadit");module.exports={Core:Core,Plugin:Plugin,Dummy:Dummy,ProgressBar:ProgressBar,Informer:Informer,DragDrop:DragDrop,GoogleDrive:GoogleDrive,Dropbox:Dropbox,FileInput:FileInput,Tus10:Tus10,Multipart:Multipart,Transloadit:Transloadit,Dashboard:Dashboard,MetaData:MetaData,Webcam:Webcam,Ftp:Ftp};
...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var i=arguments[e];for(var r in i)Object.prototype.hasOwnProperty.call(i,r)&&(t[r]=i[r])}return t},_svgNamespace="http://www.w3.org/2000/svg",_appendChild=require("yo-yoify/lib/appendChild"),Plugin=require("../Plugin"),FtpProvider=require("../../uppy-base/src/plugins/Ftp"),View=require("../../generic-provider-views/index"),icons=require("./icons");module.exports=function(t){function e(i,r){_classCallCheck(this,e);var o=_possibleConstructorReturn(this,t.call(this,i,r));o.type="acquirer",o.id="Ftp",o.title="Ftp",o.stateId="Ftp",o.params={},o.icon=function(){var t,e,i,r;return r=document.createElementNS(_svgNamespace,"svg"),r.setAttribute("width","128"),r.setAttribute("height","118"),r.setAttribute("viewBox","0 0 128 118"),r.setAttribute("class","UppyIcon"),_appendChild(r,[" ",(t=document.createElementNS(_svgNamespace,"path"),t.setAttribute("d","M38.145.777L1.108 24.96l25.608 20.507 37.344-23.06z"),t)," ",(e=document.createElementNS(_svgNamespace,"path"),e.setAttribute("d","M1.108 65.975l37.037 24.183L64.06 68.525l-37.343-23.06zM64.06 68.525l25.917 21.633 37.036-24.183-25.61-20.51z"),e)," ",(i=document.createElementNS(_svgNamespace,"path"),i.setAttribute("d","M127.014 24.96L89.977.776 64.06 22.407l37.345 23.06zM64.136 73.18l-25.99 21.567-11.122-7.262v8.142l37.112 22.256 37.114-22.256v-8.142l-11.12 7.262z"),i)," "]),r},o.Ftp=new FtpProvider(o.opts,o.params),o.files=[],o.render=o.render.bind(o);var n={};return o.opts=_extends({},n,r),o}return _inherits(e,t),e.prototype.install=function(){this.view=new View(this),this.core.setState({Ftp:{authenticated:!1,files:[],folders:[],directories:[],activeRow:-1,filterInput:""}}),this.view.handleAuth=this.handleAuth.bind(this),this.view.getFolder=this.getFolder.bind(this),this.view.logout=this.logout.bind(this),this.view.addFile=this.addFile.bind(this);var t=this.opts.target,e=this;this.target=this.mount(t,e)},e.prototype.handleAuth=function(){this.view.updateState({loading:!0}),this.view.getFolder()},e.prototype.uninstall=function(){this.unmount()},e.prototype.isFolder=function(t){return t.is_dir},e.prototype.getItemData=function(t){return _extends({},t,{size:t.file_size})},e.prototype.getItemIcon=function(t){return icons.page_white},e.prototype.getItemSubList=function(t){return t.contents},e.prototype.getItemName=function(t){return t.file_name},e.prototype.getMimeType=function(t){return t.mime_type},e.prototype.getItemId=function(t){return t.rev},e.prototype.getItemRequestPath=function(t){return encodeURIComponent(this.getItemName(t))},e.prototype.getItemModifiedDate=function(t){return t.modified},e.prototype.getFolder=function(){var t=this;this.Ftp.list().then(function(e){if("Error"===e.Status)return void t.view.updateState({error:e.Message});for(var i=e.Data.Files,r=Array.isArray(i),o=0,i=r?i:i[Symbol.iterator]();;){var n;if(r){if(o>=i.length)break;n=i[o++]}else{if(o=i.next(),o.done)break;n=o.value}n.acquirer=t.id}t.view.updateState({files:e.Data.Files,authenticated:!0,loading:!1})})},e.prototype.addFile=function(t){var e=this,i={source:this.id,data:this.getItemData(t),name:this.getItemName(t),type:this.getMimeType(t),isRemote:!0,body:{fileId:this.getItemId(t)},remote:{host:this.opts.host,url:"",body:{fileId:this.getItemId(t)}}};this.core.emitter.emit("core:file-add",i),setTimeout(function(t){var i=void 0,r=e.core.getState().files;for(var o in r)t.name===r[o].name&&(i=o);e.core.emitter.emit("core:upload-success",i)},5e3,i)},e.prototype.logout=function(){this.view.updateState({authenticated:!1})},e.prototype.render=function(t){return this.view.render(t)},e}(Plugin);
...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,n,a){return n&&e(t.prototype,n),a&&e(t,a),t}}();require("whatwg-fetch"),module.exports=function(){function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};_classCallCheck(this,e),this.params=Object.assign({},n),this.opts=Object.assign({},t)}return _createClass(e,[{key:"init",value:function(){}},{key:"list",value:function(){var e=new Headers({Accept:"application/json","Content-Type":"application/json",Authorization:"Basic "+this.opts.bearerToken}),t=new Request(this.opts.host+this.opts.getFilesUrl,{method:"get",headers:e});return fetch(t).then(function(e){return e.json()})}}]),e}();
